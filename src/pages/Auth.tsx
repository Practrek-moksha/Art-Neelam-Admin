      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="relative inline-block">
            ...
            <span className="absolute top-0 -right-4 text-[10px] font-bold text-foreground/70">™</span>
          </div>
          <h1 className="font-display text-2xl font-bold text-foreground">Academy Manager</h1>
          ...
          {mode === "forgot" && (
            <p className="text-center text-xs text-muted-foreground font-body">
              <button type="button" onClick={() => { setMode("login"); setError(""); setMessage(""); }}
                className="text-primary font-semibold hover:underline">Back to Sign In</button>
            </p>
          )}
        </form>
      </div>
