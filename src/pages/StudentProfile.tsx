    ...
    <div className="p-4 md:p-6 space-y-4 max-w-2xl mx-auto">
      ...
      <div className="bg-card rounded-2xl shadow-card border border-border p-5">
        ...
        <div className="flex gap-2 mt-2 flex-wrap">
          <button onClick={() => openWhatsApp(student.whatsapp, templates.feeReminder(student.name, totalPending))} className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-warm text-warm-foreground text-[10px] font-semibold hover:opacity-80"><Send className="w-3 h-3" /> Fee Reminder</button>
      ...
      <div className="grid grid-cols-2 gap-3">
        <StatCard icon={BookOpen} label="Sessions Left" value={String(sessionsRemaining)} sub={`of ${student.total_sessions} total`} color="primary" />
