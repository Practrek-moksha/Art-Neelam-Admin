        ...
        <div className="p-4 border-b border-border">
          <a href="https://nasdemo1.lovable.app/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <div className="relative inline-block">
              <img src={logoImg} alt="Art Neelam Academy" className="w-full max-w-[180px] h-auto rounded-xl" />
              <span className="absolute top-0 -right-3 text-[8px] font-bold text-foreground/70">™</span>
            </div>
          </a>
          <p className="text-xs text-muted-foreground font-body mt-1 pl-1">Academy Manager</p>
        </div>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-card border-b border-border shadow-sm pt-safe">
        <div className="flex items-center justify-between px-3 py-2">
          <a href="https://nasdemo1.lovable.app/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
            <div className="relative inline-block">
              <img src={logoImg} alt="Art Neelam Academy" className="w-28 h-auto rounded-lg" />
